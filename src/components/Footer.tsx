...
const Footer = () => {
    ...
    const followUs =["Instagram", "Tiktok", "X"]
    ...
    <div className="flex flex-col py-6 px-12 gap-y-4 bg-green-900">
      <div className="flex flex-col md:flex-row justify-between mb-8 gap-y-6">
        <div className="max-w-1/2">
            <h1 className="text-2xl text-white font-bold mb-4">EduGreen Foundation</h1>
            <p className="text-white">Jalan Majapahit No.666</p>
            <p className="text-white">edugreen@foundation.org</p>
        </div>
      ...
      <div className=" border-t-[.5px] flex justify-center pt-6">
        <p className="text-white/50">© EduGreen Foundation. All Right Reserved</p>
      </div>
    </div>
  )
}
